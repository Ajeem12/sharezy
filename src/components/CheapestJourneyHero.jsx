...
import { FaGasPump, FaRupeeSign, FaUserFriends, FaArrowRight } from 'react-icons/fa';
    ...
    <section className="max-w-7xl mx-auto px-2 py-6 ">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          >
            Driving soon? Let's make it <span className="text-blue-600 bg-blue-600 bg-clip-text ">super affordable.</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Turn your solo drive into a smart trip. Share your ride, split the cost, and connect with fellow travelers. It's easy, secure, and cheaper than ever.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-800 font-medium">Save up to 70% fuel cost</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-800 font-medium">Meet verified co-riders</p>
            </motion.div>
          </motion.div>
