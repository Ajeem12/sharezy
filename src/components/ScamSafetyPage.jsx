...
const features = [
  ...
  },
  {
    ...
    description: "All riders are background-checked for your safety",
    bgColor: "bg-blue-100",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`h-full p-2 md:p-6 rounded-2xl ${feature.bgColor} transition-all duration-300 group-hover:shadow-xl`}
              >
                <div
                  className={`text-5xl mb-6 ${feature.iconColor} transition-transform duration-300 group-hover:scale-110`}
                >
                  {feature.icon}
                </div>
