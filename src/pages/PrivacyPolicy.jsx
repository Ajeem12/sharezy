    ...
    <div className="p-6 sm:p-10">
      ...
      <div className="text-justify text-gray-700 leading-relaxed space-y-6">
        ...
        <p>
          ...
          disclosure of your information, at anytime, by contacting us at or
          mailing us at: Head Office - 68JX+G36, Kurud Rd, Kohka, Bhilai,
          Chhattisgarh 490026
        </p>
        ...
        <p>
          We use a secure payment gateway for processing payments. We do not
          store your card data on our servers. The data is encrypted through the
          Payment Card Industry Data Security Standard (PCI-DSS) during payment
          processing. Your transaction data is used only as long as necessary to
          complete your purchase. Once completed, the transaction information is
          not retained.
        </p>
        <p>
          Our payment gateway complies with PCI-DSS standards, which are managed
          by the PCI Security Standards Council — a collaborative effort of
          major brands such as Visa, MasterCard, American Express, and Discover.
        </p>
        <p>
          PCI-DSS requirements help ensure the secure handling of credit card
          information by our platform and its service providers.
        </p>
        ...
        <p>
          ...
          or our Office - 119, CAMP 1 SHANTI PARA, SUPELA BHILAI, DURG Pin
          490023 CHHATTISGARH
        </p>
      </div>
    </div>
