  ...
  return (
    <div className="p-6 sm:p-10">
      ...
      <div className="text-justify text-gray-700 leading-relaxed space-y-6">
        ...
        <p>
          In no case shall Sharezy, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless Sharezy and our
        ...
        <p>
          ...
          laws of India and jurisdiction of Durg, Chhattisgarh.
        </p>
